...
from api import question_api,user_api,poem_api,picture_api,question_padding_api,pk_api,img_transfer_api
...
app.include_router(img_transfer_api.router, prefix='/api')
